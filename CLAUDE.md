...
**THIS MACHINE IS: mac mini**

Hostname: liushiyudeMac-mini.local
Role: remote development machine (NOT the mac air)

When asked "which machine are you on?" or "mac air or mac mini?", answer: **mac mini**.
